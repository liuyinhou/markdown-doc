...
public class DbInitUtil {
	...
	public static boolean initDb() {
		...
		try {
			...
			st.execute("CREATE TABLE t_topic_content(id INTEGER GENERATED BY DEFAULT AS IDENTITY, topic_id INTEGER, content_markdown VARCHAR(50000), content_html VARCHAR(50000), remark VARCHAR(2000), operator_id INTEGER, status INTEGER, create_time TIMESTAMP, update_time TIMESTAMP);");
			//初始化数据
